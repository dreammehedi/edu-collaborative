...
function AcceptStudySessionModal({ onSubmit }) {
    ...
    <>
      ...
      >
        ...
        <div className="space-y-1">
          ...
          <input
            {...register("maxParticipants", { required: true, max: 100 })}
            type="number"
...
AcceptStudySessionModal.propTypes = {
  onSubmit: PropTypes.func,
};
export default AcceptStudySessionModal;
