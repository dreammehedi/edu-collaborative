...
function Button({ name, children }) {
  return (
    <>
      <button className="group relative h-12 overflow-hidden overflow-x-hidden rounded-md bg-primary px-6 md:px-8 md:py-2 text-neutral-50 flex justify-between items-center gap-2">
